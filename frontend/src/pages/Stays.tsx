...
export const Stays = () => {
  ...
  return (
    <Stack spacing={4} direction='row' align='center' border="2px solid lightGray" height="70px" borderRadius="100px" marginLeft="250px" width="900px">
      <Box as='button' borderRadius='100px' bg="white" fontWeight="500" _hover={{ bg: "gray.100" }} color='black' px={4} h={8} height="65px" width="200px" border="none" onClick={onOpen}>
        Where
        <Input variant='unstyled' placeholder='Search destinations' ml={5} />
            ...
            <ModalBody>
              <Text>
                <Stack display="flex" direction='row' flexWrap="wrap" gap={3}>
                  <Box w='125px' _hover={background} cursor={"pointer"}>
      ...
      >
        Check in
        <Input variant='unstyled' placeholder='Add dates' ml={"40px"} />
      </Box>
      <Modal isOpen={showCalendar} onClose={handleBoxClick}> 
      
        <ModalContent mt={"150px"} paddingBottom={"20px"}>
          <ModalBody>
            <Calendar />
          </ModalBody>
        </ModalContent>
      ...
      <Modal isOpen={showCalendar2} onClose={handleBoxClick2}> 
      
        <ModalContent mt={"150px"} paddingBottom={"10px"}>
          <ModalBody>
            <Calendar />
          </ModalBody>
        </ModalContent>
