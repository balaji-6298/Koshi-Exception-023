...
export const Countrysides = () => {
  ...
  useEffect(() => {
    if (obj.length > 0) {
      const pools: Countryside[] = obj.flatMap((ele) => ele.Countryside);
      setArr(pools);
    }
  }, [obj]);
